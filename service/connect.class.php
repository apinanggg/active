...
class DB
{
    private static $DB_HOST = '164.115.62.66'; /** กำหนด Property $DB_HOST */
    private static $DB_USERNAME = 'root'; /** กำหนด Property $DB_USERNAME */
    private static $DB_PASSWORD = 'Csc01#1234'; /** กำหนด Property $DB_PASSWORD */
    private static $DB_DATABASE = 'active'; /** กำหนด Property $DB_DATABASE */
